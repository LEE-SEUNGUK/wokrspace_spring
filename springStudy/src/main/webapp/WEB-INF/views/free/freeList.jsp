   ...
   <section class="page-section" id="contact">
      <div class="container" style="margin-top: 100px;">
               ...
               <div class="col-auto col-sm-5 mb-3">
                  <form name="search" action="<c:url value="/free/freeList" />" method="post">
                     ...
                     <div class="input-group">
                        ...
                        <div class="col-sm-2">
                           <select id="id_searchCategory" class="form-control input-sm">
                        ...
                        <div class="col-sm-6">
                           <input class="form-control shadow-none search" 
                                 type="search" name="searchWord" value="${searchVO.searchWord}" placeholder="검색어">
                        </div>
         ...
         <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-primary" href="freeForm" >글쓰기</a>
         </div>
         <!-- START : 페이지네이션  -->
         <nav aria-label="Page navigation example">
            ...
            <c:if test="${searchVO.firstPage != 1}">
               <li class="page-item">
                  <a class="page-link" aria-lable="Previous" href="#" data-page="${searchVO.firstPage-1}">
            ...
            <c:if test="${searchVO.lastPage != searchVO.totalPageCount}">
               <li class="page-item">
                  <a class="page-link" aria-lable="Next" href="#" data-page="${searchVO.lastPage+1}">
