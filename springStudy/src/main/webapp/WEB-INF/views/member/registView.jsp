                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <form id="contactForm" action="/registDo" method="post">
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" id="id" name="memId" type="text" placeholder="아이디를 입력하세요" data-sb-validations="required" />
                                <label for="id">ID</label>
                                <div class="invalid-feedback" data-sb-feedback="id:required">아이디는 필수입니다</div>
                            </div>
                            <!-- Email address input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="pw" name="memPw" type="password" placeholder="비밀번호를 입력하세요" data-sb-validations="required" />
                                <label for="pw">Password</label>
                                <div class="invalid-feedback" data-sb-feedback="pw:required">비밀번호는 필수입니다</div>
                            </div>
                            <!-- Phone number input-->
                            <div class="form-floating mb-3">
                                <input class="form-control" id="name" name="memNm" type="tel" placeholder="이름을 입력하세요" data-sb-validations="required" />
