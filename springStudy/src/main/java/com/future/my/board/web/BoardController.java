...
public class BoardController {
	...
	public String boardView(Model model) {
		...
		// Model 객체에 추가하면 뷰에서 데이터를 사용할 수 있음
		model.addAttribute("boardList", boardList); // 키, 밸류 형식으로 담는다
	...
	@PostMapping("/boardEditUpdateDo")
	public String boardUpdatevDo(BoardVO board) throws Exception {
		boardService.updateBoard(board);
		return "redirect:/boardView";
	}

	@PostMapping("/boardDelDo")
	public String boardDelDo(BoardVO board) throws Exception {
	...
	@ResponseBody
	@PostMapping("/writeReplyDo") // @RequestBody 문자열 json 데이터를 객체로 받음
