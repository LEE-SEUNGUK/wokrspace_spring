...
public class CodeController {
	...
	// 삭제
	@DeleteMapping(value = "/deleteCode/{comm_cd}", produces = "application/json; charset=UTF-8") // PathVariable 리소스의 경로의 일부를 전달받을 때
	public ResponseEntity<String> deleteCode(@PathVariable String comm_cd){
		...
		try {
			...
			return new ResponseEntity<>("삭제 되었슴...", HttpStatus.OK);
		} catch (Exception e) {
